...
class CustomOpcodes
{
	...
	static eOpcodeResult WINAPI IS_PLAYER_TOUCHING_OBJECT(CScript *script);
	static eOpcodeResult WINAPI IS_CHAR_TOUCHING_OBJECT(CScript *script);
	...
	static eOpcodeResult WINAPI IS_PLAYER_TOUCHING_OBJECT_ON_FOOT(CScript *script);
	static eOpcodeResult WINAPI IS_CHAR_TOUCHING_OBJECT_ON_FOOT(CScript *script);
	static eOpcodeResult WINAPI ARM_CAR_WITH_BOMB(CScript *script);
	static eOpcodeResult WINAPI IS_BOAT(CScript *script);
	static eOpcodeResult WINAPI IS_CHAR_STOPPED(CScript *script);
	...
	static eOpcodeResult WINAPI IS_CHAR_IN_ANY_HELI(CScript *script);
	static eOpcodeResult WINAPI IS_CHAR_IN_ANY_PLANE(CScript *script);
	static eOpcodeResult WINAPI IS_CHAR_IN_FLYING_VEHICLE(CScript *script);
	static eOpcodeResult WINAPI GET_MAX_WANTED_LEVEL(CScript *script);
	static eOpcodeResult WINAPI IS_CHAR_TOUCHING_VEHICLE(CScript *script);
